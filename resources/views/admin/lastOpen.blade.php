                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Apostas Recentes</b></h4>
                            <p class="text-muted font-13 m-b-30">
                                Todas as Apostas Recentes dos usuários são mostradas aqui
                            </p>
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                @foreach($opens as $live)
                                    <tr>
                                        <td>{{$live->id}}</td>
                                        <td>R$ {{$live->bet}}</td>
<td><a href="/user/{{$live->user->id}}">{{$live->user->username}}</a></td>
                                        <td>R$ {{$live->win}}</td>
                                        <td>R$ {{$live->bet - $live->win}}</td>
                                    </tr>
                                @endforeach
