...
<span class="profile__content-header-tab profile__content-header-tab_active">Depósitos</span>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td class="table__td">Depósitos {{$p->amount}}</td>
